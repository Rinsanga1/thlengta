...
exports.index = async (req, res) => {
  ...
  if (plan !== "enterprise") {
    return res.renderPage("admin/managers/index", { // Renamed view
      title: "Managers",
      store,
      managers: [],
      enterpriseOnly: true,
...
exports.new = async (req, res) => {
  ...
  const plan = String(admin?.plan || "").toLowerCase();
  if (plan !== "enterprise") {
    return res.renderPage("admin/managers/new", { // Renamed view
      title: "Add Manager",
      store,
...
exports.create = async (req, res) => {
  try {
    ...
    return res.redirect(
      `/admin/stores/${storeId}/managers?type=success&msg=` +
